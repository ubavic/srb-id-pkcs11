...
pub const CK_INFO = extern struct {
    cryptokiVersion: CK_VERSION align(1) = @import("std").mem.zeroes(CK_VERSION),
    manufacturerID: [32]CK_UTF8CHAR align(1) = @import("std").mem.zeroes([32]CK_UTF8CHAR),
    flags: CK_FLAGS align(1) = 0,
    libraryDescription: [32]CK_UTF8CHAR align(1) = @import("std").mem.zeroes([32]CK_UTF8CHAR),
    libraryVersion: CK_VERSION align(1) = @import("std").mem.zeroes(CK_VERSION),
};
...
pub const CK_FUNCTION_LIST = extern struct {
    version: CK_VERSION align(1) = @import("std").mem.zeroes(CK_VERSION),
    C_Initialize: CK_C_Initialize align(1) = null,
    C_Finalize: CK_C_Finalize align(1) = null,
    C_GetInfo: CK_C_GetInfo align(1) = null,
    C_GetFunctionList: CK_C_GetFunctionList align(1) = null,
    C_GetSlotList: CK_C_GetSlotList align(1) = null,
    C_GetSlotInfo: CK_C_GetSlotInfo align(1) = null,
    C_GetTokenInfo: CK_C_GetTokenInfo align(1) = null,
    C_GetMechanismList: CK_C_GetMechanismList align(1) = null,
    C_GetMechanismInfo: CK_C_GetMechanismInfo align(1) = null,
    C_InitToken: CK_C_InitToken align(1) = null,
    C_InitPIN: CK_C_InitPIN align(1) = null,
    C_SetPIN: CK_C_SetPIN align(1) = null,
    C_OpenSession: CK_C_OpenSession align(1) = null,
    C_CloseSession: CK_C_CloseSession align(1) = null,
    C_CloseAllSessions: CK_C_CloseAllSessions align(1) = null,
    C_GetSessionInfo: CK_C_GetSessionInfo align(1) = null,
    C_GetOperationState: CK_C_GetOperationState align(1) = null,
    C_SetOperationState: CK_C_SetOperationState align(1) = null,
    C_Login: CK_C_Login align(1) = null,
    C_Logout: CK_C_Logout align(1) = null,
    C_CreateObject: CK_C_CreateObject align(1) = null,
    C_CopyObject: CK_C_CopyObject align(1) = null,
    C_DestroyObject: CK_C_DestroyObject align(1) = null,
    C_GetObjectSize: CK_C_GetObjectSize align(1) = null,
    C_GetAttributeValue: CK_C_GetAttributeValue align(1) = null,
    C_SetAttributeValue: CK_C_SetAttributeValue align(1) = null,
    C_FindObjectsInit: CK_C_FindObjectsInit align(1) = null,
    C_FindObjects: CK_C_FindObjects align(1) = null,
    C_FindObjectsFinal: CK_C_FindObjectsFinal align(1) = null,
    C_EncryptInit: CK_C_EncryptInit align(1) = null,
    C_Encrypt: CK_C_Encrypt align(1) = null,
    C_EncryptUpdate: CK_C_EncryptUpdate align(1) = null,
    C_EncryptFinal: CK_C_EncryptFinal align(1) = null,
    C_DecryptInit: CK_C_DecryptInit align(1) = null,
    C_Decrypt: CK_C_Decrypt align(1) = null,
    C_DecryptUpdate: CK_C_DecryptUpdate align(1) = null,
    C_DecryptFinal: CK_C_DecryptFinal align(1) = null,
    C_DigestInit: CK_C_DigestInit align(1) = null,
    C_Digest: CK_C_Digest align(1) = null,
    C_DigestUpdate: CK_C_DigestUpdate align(1) = null,
    C_DigestKey: CK_C_DigestKey align(1) = null,
    C_DigestFinal: CK_C_DigestFinal align(1) = null,
    C_SignInit: CK_C_SignInit align(1) = null,
    C_Sign: CK_C_Sign align(1) = null,
    C_SignUpdate: CK_C_SignUpdate align(1) = null,
    C_SignFinal: CK_C_SignFinal align(1) = null,
    C_SignRecoverInit: CK_C_SignRecoverInit align(1) = null,
    C_SignRecover: CK_C_SignRecover align(1) = null,
    C_VerifyInit: CK_C_VerifyInit align(1) = null,
    C_Verify: CK_C_Verify align(1) = null,
    C_VerifyUpdate: CK_C_VerifyUpdate align(1) = null,
    C_VerifyFinal: CK_C_VerifyFinal align(1) = null,
    C_VerifyRecoverInit: CK_C_VerifyRecoverInit align(1) = null,
    C_VerifyRecover: CK_C_VerifyRecover align(1) = null,
    C_DigestEncryptUpdate: CK_C_DigestEncryptUpdate align(1) = null,
    C_DecryptDigestUpdate: CK_C_DecryptDigestUpdate align(1) = null,
    C_SignEncryptUpdate: CK_C_SignEncryptUpdate align(1) = null,
    C_DecryptVerifyUpdate: CK_C_DecryptVerifyUpdate align(1) = null,
    C_GenerateKey: CK_C_GenerateKey align(1) = null,
    C_GenerateKeyPair: CK_C_GenerateKeyPair align(1) = null,
    C_WrapKey: CK_C_WrapKey align(1) = null,
    C_UnwrapKey: CK_C_UnwrapKey align(1) = null,
    C_DeriveKey: CK_C_DeriveKey align(1) = null,
    C_SeedRandom: CK_C_SeedRandom align(1) = null,
    C_GenerateRandom: CK_C_GenerateRandom align(1) = null,
    C_GetFunctionStatus: CK_C_GetFunctionStatus align(1) = null,
    C_CancelFunction: CK_C_CancelFunction align(1) = null,
    C_WaitForSlotEvent: CK_C_WaitForSlotEvent align(1) = null,
};
...
pub const CK_C_INITIALIZE_ARGS = extern struct {
    CreateMutex: CK_CREATEMUTEX align(1) = null,
    DestroyMutex: CK_DESTROYMUTEX align(1) = null,
    LockMutex: CK_LOCKMUTEX align(1) = null,
    UnlockMutex: CK_UNLOCKMUTEX align(1) = null,
    flags: CK_FLAGS align(1) = 0,
    pReserved: CK_VOID_PTR align(1) = null,
};
